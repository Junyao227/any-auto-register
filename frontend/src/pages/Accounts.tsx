  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const registerExtra = {
        ...
        chatgpt_phone_provider: cfg.chatgpt_phone_provider,
        hero_sms_api_key: cfg.hero_sms_api_key,
        hero_sms_base_url: cfg.hero_sms_base_url,
        hero_sms_service: cfg.hero_sms_service,
        hero_sms_country_id: cfg.hero_sms_country_id,
        hero_sms_country_label: cfg.hero_sms_country_label,
